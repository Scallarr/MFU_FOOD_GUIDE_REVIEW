...
//   void startTypingEffect(String fullText) {
//     _typingTimer?.cancel();
//     _currentTypingText = '';
//     _typingIndex = 0;
//     _isTyping = true;

//     // เพิ่มข้อความเปล่าเพื่อแสดงตำแหน่ง
//     setState(() {
//       _messages.add({
//         "role": "bot",
//         "content": "",
...
//         setState(() {
//           _currentTypingText += fullText[_typingIndex];
//           _messages.last["content"] = _currentTypingText;
//           _typingIndex++;
//         });
//         scrollToBottom();
//       } else {
...
//       // เริ่มเอฟเฟกต์การพิมพ์ทีละตัวอักษร
...
//                   itemCount:
//                       _messages.length + (_isLoading && !_isTyping ? 1 : 0),
