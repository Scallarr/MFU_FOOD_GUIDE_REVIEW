...
class RestaurantReviewHistoryUserPage extends StatefulWidget {
  @override
...
class _RestaurantReviewHistoryPageState
    extends State<RestaurantReviewHistoryUserPage>
  ...
  Future<void> _fetchAllData() async {
    ...
    try {
      await Future.wait([_fetchMyReviews()]);
    } catch (e) {
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: _isLoading ? _buildLoadingView() : _buildMyReviews(),
            ),
          ),
        ],
      ),
