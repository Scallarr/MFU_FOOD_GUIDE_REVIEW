...
class userRoleAdminPage extends StatefulWidget {
  @override
  _AllUsersPageState createState() => _AllUsersPageState();
}

class _AllUsersPageState extends State<userRoleAdminPage> {
  ...
  Future<void> _fetchAllUsers() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://172.22.173.39:8080/Usermanagement/users/Adminrole'),
      );
